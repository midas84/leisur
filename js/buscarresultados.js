 	...
 	function lookup(inputString) {
		...
		$.post("php/motorjsresultados.php", {buscar: inputString, funcion: nombrecategoria }, function(data){
				if(data.length >0) {
					$('#suggestions').show();
	...
	function fill(thisValue,idcategoria) {
		...
		$.post("php/motorjsresultados.php", {buscar: idcategoria, funcion: nombreanalisis }, function(data){
	...
	function mostrarresultados(thisValue){
		...
		$.post("php/motorjsresultados.php", {buscar: thisValue, funcion: tabla}, function(data){
				if(data.length >0) {
					$('#suggestions').show();
					$('#autoSuggestionsList').html(data);
				} else {
