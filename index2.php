  ...
  <div class="body1">
    <div class="main">
      <header>
        <div class="wrapper">
          <h1>
            <div id="logo"></div><span id="slogan">Sucre-Bolivia</span>
          </h1>
          <div class="right">
            <nav>
              <ul id="top_nav">
        ...
        <div class="footerlink">
          ...
          <form name="form_reloj">
            <input type="text" name="reloj" size="10"
              style="background-color :#FFFFFF; color :#313439; font-family : Verdana, Arial, Helvetica; font-size : 8pt; text-align : center;"
