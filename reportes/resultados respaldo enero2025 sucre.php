...
#marca {
    ...
    function cabecera($todo, $cab, $idsol)
    {
        ...
        $cab = $cab . '<img id="logo" src="logo.jpg" />
...
$fechadeimpresion= date('d/m/Y H:i:s');
    ...
    <table  border="1" cellspacing="0" cellpadding="5" id="cabecera">
            ...
            ' ' . $todo[0]['apellidos'] .
            '<br>CI:' . $ci .
            '<br> Doctor: '.$todo[0]['nombredoctor'].'</td></tr></table>
<table id="edad"><tr><td colspan="2">Edad:' . $todo[0]['edad'] . '<br>Pac./d&iacute;a. :' . $todo[0]['numerodia'] .
...
<div id="direcciones" >Cel.:76116115 <br /> cell.diagnostic@gmail.com <br />Reg.SEDES CH. N. 10/2024 </div><table id="ho"><div id="pie">
<div id="fechaimpresion">Fecha de impresi&oacute;n: '.$fechadeimpresion.'</div><hr /> Sucre: Destacamento 111 No. 165; Descatamento 130 No. 296A <br/>Santa Cruz: Calle Cuellar No. 152 entre 21 de Mayo y Libertad <br /> @laboratoriocelldiagnostic <br />  Laboratorio Cell-Diagnostic </diV>';
    }
